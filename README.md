...
| 7 | **Remote Control** <br> - Remote control - BLE [bluetooth](references/bluetooth.md) and WiFI [wifi](references/wifi.md)<br> - Working Discussion: 3 Concepts "Affective Machines" <br> - Assign HW 7a: Final Project Proposal and 7b:Low Fidelity Prototype <br> - Assign Reading 7: _My Elegant Robot Freedom_ <br> |
