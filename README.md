...
| 5 | **Behaviors** - Programming Movement <br> - Midterm Work Time <br> - [DC Motor Driver with Colin's Motor Driver Shield](references/dev_board_actuators.md#dc-motors) <br> - [Servos with PCA9685 Board](references/dev_board_actuators.md#pca9685-12bit-servo-driver) <br> -Assign Reading 5: _Designing Sociable Robots_ <br> - DUE Fri  - Midterm Proposal+Prototype|
